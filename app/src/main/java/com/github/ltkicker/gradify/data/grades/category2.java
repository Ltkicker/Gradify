...
public class category2  extends total_percent_parent_category{


    private String parentCategory;
    private String subCategory;

    public category2( String parent_category, String sub_category, int raw_score, double parent_category_percentage) {
    ...
    public void getSubCatCount(String parent_category, String sub_category){
        ...
        DatabaseReference deRef = FirebaseDatabase.getInstance().getReference().child("NZItQ2M6m_y9IXcgOW7").child("parentcategory").child("parentcategory2").child("percentage");
        DatabaseReference  subDeRef = FirebaseDatabase.getInstance().getReference().child("grades").child("NZItQ2M6m_y9IXcgOW7").child("students").child("id").child("parentecategory").child("parentcategory2").child("subcategory");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                subDeRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        long totalCategory2ParentPercentage = (SumSubcategory * n) / ParentCategoryPercent;
                    }
